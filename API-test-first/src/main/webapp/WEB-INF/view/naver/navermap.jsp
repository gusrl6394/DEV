    ...
    <div class="container-fluid">
        ...
        <div>
            <ul class="nav navbar-nav">
                <li class="active"><a href="<c:url value="/navermap"/>">네이버 MAP</a></li>
            </ul>
            <ul class="nav navbar-nav">
                <li class="active"><a href="<c:url value="/naverlogin"/>">네이버 로그인</a></li>
            </ul>
        </div>
    </div>
</nav>
<nav>현재 페이지만 Bootstrap v3.3.2 으로 제작되었습니다.</nav>
